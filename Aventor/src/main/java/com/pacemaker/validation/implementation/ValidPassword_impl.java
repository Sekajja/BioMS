package com.pacemaker.validation.implementation;
...
import com.pacemaker.validation.ValidPassword;


public class ValidPassword_impl  implements ConstraintValidator<ValidPassword, String> {

	private static final Logger logger = LoggerFactory.getLogger(ValidPassword_impl.class);
